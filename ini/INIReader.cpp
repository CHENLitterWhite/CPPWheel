...
double INIReader::GetDou(const std::string& section, const std::string& name, double default_value)
{
    string valstr = Get(section, name, "");
    const char* value = valstr.c_str();
    char* end;
...
bool INIReader::GetStrArr(const std::string& section, const std::string& name, std::vector<std::string>& vec)
{
...
bool INIReader::GetInt64Arr(const std::string& section, const std::string& name, std::vector<int64_t>& vec)
{
    string str = GetString(section, name, "");
    if(str == "")
    {
    ...
    {
        char *end;
        vec.push_back(strtoull(token.c_str(), &end, 0));
    }

    return true;
}

bool INIReader::GetDouArr(const std::string& section, const std::string& name, std::vector<double>& vec)
{
    ...
    {
        char *end;
        vec.push_back(strtod(token.c_str(), &end));
    }
