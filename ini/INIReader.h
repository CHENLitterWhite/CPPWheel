...
public:
    ...
    // 浮点数
    INI_API double GetDou(const std::string& section, const std::string& name, double default_value);

    // 字符数组
    INI_API bool GetStrArr(const std::string& section, const std::string& name, std::vector<std::string>& vec);

    // 整形数组
    INI_API bool GetInt64Arr(const std::string& section, const std::string& name, std::vector<int64_t>& vec);

    // 浮点数组
    INI_API bool GetDouArr(const std::string& section, const std::string& name, std::vector<double>& vec);
