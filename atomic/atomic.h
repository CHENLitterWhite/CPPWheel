...
#define ATOM_SIZE volatile size_t
#define ATOM_ULOG volatile unsigned long
...
#define ATOM_FSUB(ptr, n) __sync_fetch_adn_sub(ptr, n)
...
#define ATOM_SIZE STD_ atomic_size_t
#define ATOM_ULONG STD_ atomic_ulong

#define ATOM_INIT(ptr, v) STD_ atomic_init(ptr, v)
...
#define ATOM_FSUB(ptr, n) __sync_fetch_adn_sub(ptr, atomic_value_type_(ptr, n))
#define ATOM_FAND(ptr, n) __sync_fetch_and_and(ptr, atomic_value_type_(ptr, n))
